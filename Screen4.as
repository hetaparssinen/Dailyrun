...
public class Screen4 extends Sprite
	{
		...
		public function Screen4( assetManager:AssetManager, score:int )
		{
		...
		private function draw():void {
			...
			text = new TextField( 300, 100, "Good, now you have a laptop!!", "Verdana", 30, 0, true );
			text.alignPivot();
			text.x = 250;
			text.y = 50;
			addChild( text );
			...
			object1 = new Button(assetManager.getTexture("laptop"));
			object1.alignPivot();
			object1.scale = 0.4;
			object1.x = 240;
			object1.y = 250;
